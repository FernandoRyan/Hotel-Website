  	...
  	<section class="header">
		<div class="container">
			<nav  class="nav">
					...
					<ul class="nav-list">
					<li class="nav-item">
						<a href="../index.html" class="nav-link"><span class="hvr-grow">HOME</span></a>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
						<a href="../Accommadation/Accommadation.html" class="nav-link"><span class="hvr-grow">Accommadation</span></a>
					</li> 
					<li class="nav-item">
						<a href="../Facilities/facilities.html" class="nav-link"><span class="hvr-grow">Facilities</span></a>
					</li>
					<li class="nav-item">
...
<h1 id="h5">Superior Queen Room city-or courtyard view</h1>
<hr style="width:87%;border-top: 2px solid #616161">
   ...
   <!-- calender -->
      ...
      <tr>
        <td style="color:#cca42f;">27</td>
        <td style="color:#cca42f;">28</td>
        <td style="color:#cca42f;">29</td>
        <td style="color:#cca42f;">30</td>
        <td style="color:#cca42f;">31</td>
        <td id="dayhover">1</td>
      ...
      <tr>
        ...
        <td style="color:#cca42f;">1</td>
        <td style="color:#cca42f;">2</td>
  ...
  <div class="info">
    ...
    <font=Microsoft Sans Serif>
        <h2 style="font-family: Courier New; font-size: 30px; color: #363636;"><b>Room Details</b></h2>
        
        <p style="color:#6b6b6b;">Superior King Room city-or courtyard view Rooms offer space and comfort with<br> thoughtful contemporary design and local Sri Lankan touches. All rooms offer<br> exceptional views over the Lake and the city beyond.</p>
        ...
        <ul style="color:#6b6b6b;">
          ...
          <li>Telephone with external line</li>
          <li>Mini Bar</li>
  ...
  <div class="imgpos">
  <img class="sideimg" src="../Accommadation/images/room1.jpg">
  </div>
  ...
  <tr>
       <!-- inserting date-->
        <h2 style="color: #204051;">Current Date</h2>
        <td></td><td></td>  <td></td>  
  ...
  <table style="margin-left:3.5%;" border="0">
    ...
    <br>
      ...
      <input type="hidden" name="room" value="Superior Queen Room city-or courtyard view">
  ...
  <!-- Footer -->
      <footer class="footer">
          <div class="container"> 
            <div class="footer-content-brand">
              <a href="#" class="logo">
               ...
               <div class="paragraph">where our sprits meet your style
            </div> 
          <div class="socail-media-wrap">
            <h4 class="footer-heading">Follow us</h4>
            <div class="socail-media">
            <a href="#" class="sm-link"><i class="fab fa-twitter fa-2x"></i></a>
            <a href="https://www.facebook.com/kavindu.prabath.9404" class="sm-link" target="_blank"><i class="fab fa-facebook-square fa-2x"></i></a>
            <a href="https://www.instagram.com/kavinduprabath/" class="sm-link" target="_blank"><i class="fab fa-instagram fa-2x"></i></a>
            <a href="#" class="sm-link"><i class="fab fa-pinterest fa-2x"></i></a>
          </div>
        </div>
      </div> 
    </div>
        ...
        <p>&copy;SEA SIDE SOUTH PARK | Designed by Kavindu Prabath</p>
    </div>
